...
import AboutLinks from './NavAboutUsLinks';
import IndustriesLinks from './NavIndustriesLinks';
import ServicesLinks from './NavServicesLinks';
import NavTechnologiesLinks from './NavTechnologiesLinks';
import NavWorkLinks from './NavWorkLinks';
            ...
            <nav ref={navbarRef} className="fixed top-0 z-[100] w-full transition-all duration-300" style={{ backgroundColor: 'transparent' }}>
                <MaxWidthWrapper>
                    <div className="flex h-20 items-center justify-between">
                        ...
                        {/* Desktop Navigation */}
                        <div className={`hidden items-center space-x-8 text-lg font-bold md:flex ${isScrolled ? 'text-gray-900' : 'text-white'}`}>
                            ...
                            <Link
                                ...
                                className={`group relative  overflow-hidden rounded-xl px-4 py-2 hover:animate-none ${
