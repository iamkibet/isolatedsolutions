...
import { Activity, BarChart, Building2, FileText, Globe, Lock, Scale, Settings, Shield, Sparkles, Users } from 'lucide-react';
                    ...
                    <div className="grid items-center gap-16 py-24 lg:grid-cols-2">
                        <div className="relative z-10 space-y-8">
                            ...
                            <p className="text-xl leading-relaxed text-gray-300">
                                Create innovative government solutions that enhance public services and citizen engagement
                            </p>
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div className="rounded-xl border border-white/10 bg-white/5 p-4 backdrop-blur-sm">
                                    <div className="mb-2 flex items-center gap-3">
                                        ...
                                        <span className="font-medium text-white">Data Analytics</span>
                                    </div>
                                    <p className="text-sm text-gray-400">Policy insights</p>
                                </div>
                            </div>
                            ...
                            <div className="relative space-y-6 p-8">
                                <div className="flex items-center gap-4 rounded-xl border border-white/10 bg-white/5 p-4 backdrop-blur-sm">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-300">Secure record keeping</p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-4 rounded-xl border border-white/10 bg-white/5 p-4 backdrop-blur-sm">
                                    <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-white/10">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold text-white">Citizen Services</h3>
                                        <p className="text-gray-300">Public engagement platform</p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-4 rounded-xl border border-white/10 bg-white/5 p-4 backdrop-blur-sm">
                                    <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-white/10">
            ...
            <section className="bg-gradient-to-br from-gray-50 to-white py-20">
                <MaxWidthWrapper>
                    <div className="mb-16 text-center">
                        <h2 className="mb-4 text-4xl font-bold text-gray-900">Comprehensive Government Solutions</h2>
                        <p className="mx-auto max-w-2xl text-xl text-gray-600">Empowering government agencies with innovative technology</p>
                    </div>
                    <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                        ...
                        <div className="group rounded-2xl border border-gray-100 bg-white p-8 shadow-lg transition-all duration-300 hover:shadow-xl">
                            ...
                            <p className="mb-6 text-gray-600">Secure document handling</p>
                        ...
                        <div className="group rounded-2xl border border-gray-100 bg-white p-8 shadow-lg transition-all duration-300 hover:shadow-xl">
                            ...
                            <p className="mb-6 text-gray-600">Enhanced public engagement</p>
                            <ul className="space-y-3 text-gray-600">
                                <li className="flex items-center gap-2">
                        ...
                        <div className="group rounded-2xl border border-gray-100 bg-white p-8 shadow-lg transition-all duration-300 hover:shadow-xl">
                            ...
                            <p className="mb-6 text-gray-600">Enterprise-grade security</p>
                            <ul className="space-y-3 text-gray-600">
                                <li className="flex items-center gap-2">
            ...
            <section className="bg-gradient-to-br from-gray-900 to-black py-20">
                <MaxWidthWrapper>
                    <div className="space-y-8 text-center">
                        <h2 className="text-4xl font-bold text-white">Ready to Transform Governance?</h2>
                        <p className="mx-auto max-w-2xl text-xl text-gray-300">Let's create innovative government solutions for your agency</p>
